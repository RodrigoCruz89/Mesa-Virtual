...
def upgrade() -> None:
    ...
    # Índice explícito: GET /detalles_pedido/pedido/{id} filtra siempre por id_pedido
    op.create_index('ix_detalles_pedido_id_pedido', 'detalles_pedido', ['id_pedido'], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('pagos')
    op.drop_index('ix_detalles_pedido_id_pedido', table_name='detalles_pedido')
